...
$config['SITE_PATH'] = str_replace('\\', '/', realpath('..') . '/slim_care/');
//$config['PROTECTED_FOLDER'] = 'protected/';
$config['BASE_PATH'] = str_replace('\\', '/', realpath('..') . '/dooframework/');
//for production mode use 'prod'
//$config['APP_MODE'] = 'dev';
$config['APP_MODE'] = ($_SERVER['HTTP_HOST'] == '127.0.0.1' || $_SERVER['HTTP_HOST'] == 'localhost') ? 'dev' : 'prod';
