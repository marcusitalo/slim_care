                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light rounded h-100 p-4">
                            <h6 class="mb-4"><?php echo $data['subtitulo']; ?> para <?php echo $data['place']; ?></h6>
                            <form action='<?php echo $data['action']; ?>' method='POST'>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea type="text" class="form-control" id="exampleInputguidance" name="guidance" value="<?php echo $data['guidance']; ?>" required <?php echo $data['disabled']; ?>></textarea>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea type="text" class="form-control" id="exampleInputobservation" name="observation" value="<?php echo $data['observation']; ?>" required <?php echo $data['disabled']; ?>></textarea>
                                </div>
                                ...
                                <input name="place_id" type="hidden" value="<?php echo $data['place_id']; ?>"/>
