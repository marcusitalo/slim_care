                            ...
                            <form action='<?php echo $data['action']; ?>' method='POST'>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputLogin"
                                        aria-describedby="loginHelp" name="login" value="<?php echo $data['login']; ?>"  <?php echo $data['disabled']; ?>>
                                    <div id="loginHelp" class="form-text">Nome utilizado para logar no sistema
                                    </div>
                                </div>
                                <div class="mb-3">
                                    <label for="exampleInputPassword1" class="form-label">Password</label>
                                    <input type="password" class="form-control" id="exampleInputPassword1" name="senha" value="<?php echo $data['senha']; ?>"  <?php echo $data['disabled']; ?>>
                                </div>
