        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="<?php echo $data['base']; ?>usuarios" class="nav-item nav-link"><i class="fa fa-th me-2"></i>Usuários</a>
                    <a href="<?php echo $data['base']; ?>locais" class="nav-item nav-link"><i class="fa fa-th me-2"></i>Locais</a>
