                    ...
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light rounded h-100 p-4">
                            ...
                            <form action='<?php echo $data['action']; ?>' method='POST'>
                                ...
                                <div class="mb-3">
                                    <label for="exampleInputdescription_pay" class="form-label required">Descrição do pagamento</label>
                                    <input type="text" class="form-control" id="exampleInputdescription_pay" name="description_pay" value="<?php echo $data['description_pay']; ?>" required <?php echo $data['disabled']; ?>>
                                </div>
